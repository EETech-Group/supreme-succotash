  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        destructiveOutline:
          "border border-destructive/20 bg-background text-destructive hover:bg-destructive hover:text-destructive-foreground hover:border-destructive hover:shadow-sm",
        outline:
        ...
        edit: "bg-blue-500 text-white hover:bg-blue-600 hover:shadow-md transition-all duration-200",
        delete: "bg-red-500 text-white hover:bg-red-600 hover:shadow-md transition-all duration-200",
      },
      size: {
